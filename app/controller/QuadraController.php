...
class QuadraController extends Controller
{
    ...
    public function list()
    {
        ...
        $dados["quadras"] = $this->quadraService->listarTodasAsQuadras();
    ...
    public function crudquadra()
    {
        ...
        // 1° Restrição: o usuário é do tipo ADM para acessar crudquadra
        if (isset($_SESSION[SESSAO_USUARIO_TIPO]) && $_SESSION[SESSAO_USUARIO_TIPO] == UsuarioTipo::ADMINISTRADOR) {

           $dados["lista"] =  $this->quadraService->listarTodasAsQuadras();
